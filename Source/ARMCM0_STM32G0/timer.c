...
void TimerInit(void)
{
  ...
  /* Depending on the STM32G0 derivative, TIM1's clock can be sourced from PCLK (default)
   * or PLLQ. This function currently only supports the default PCLK configuration.
   * Make sure this configuration is active.
   */
