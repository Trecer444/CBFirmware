/************************************************************************************//**
* \file         Source/ARMCM3_STM32L1/timer.c
...
#include "stm32l1xx_ll_bus.h"                    /* STM32 LL BUS header                */
#include "stm32l1xx_ll_rcc.h"                    /* STM32 LL RCC header                */
...
void TimerInit(void)
{
  ...
  /* All STM32L1 derivatives support a TIM2 peripheral. Its free running counter will be
