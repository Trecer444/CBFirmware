/************************************************************************************//**
* \file         Source/ARMCM33_STM32U5/timer.c
...
#include "stm32u5xx_ll_bus.h"                    /* STM32 LL BUS header                */
...
void TimerInit(void)
{
  ...
  /* All STM32U5 derivatives support a TIM1 peripheral. Its free running counter will be
